...
public abstract class Cyborg extends Moveable implements ISteerable {
	...
	private int energyLevel = 3000;			// Resource that is needed in order for the cyborg to move around.
	...
	private static final int SPEED_LIMIT = 300; // Absolute speed limit, used to calculate the actual speed limit when a cyborg takes damage.
...
//		}
	...
	public void dimColor() {
		int newBlue = ColorUtil.blue(getColor()) - 15;
	...
	public void setEnergyLvl(int myEner) {
		energyLevel = myEner;
	}
	...
	public String toString() {
		...
		return super.toString() + head + dir;
	}
}
